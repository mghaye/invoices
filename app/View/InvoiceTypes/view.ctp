...
<h2><?php echo __('Invoice Type'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($invoiceType['InvoiceType']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($invoiceType['InvoiceType']['modified']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Invoice Type'), array('action' => 'delete', $invoiceType['InvoiceType']['id']), array(), __('Are you sure you want to delete # %s?', $invoiceType['InvoiceType']['id'])); ?> </li>
...
<div class="related">
	...
	<?php foreach ($invoiceType['Invoice'] as $invoice): ?>
		<tr>
