...
//$('#InvoiceVirtual').click(function () {
	
	//if($('#InvoiceVirtual').prop('checked')) {
	//	$("InvoiceInvoiceNumberInt").prop('disabled', true);
	//	alert("message");
	//}else{
	//	$("InvoiceInvoiceNumberInt").prop('disabled', false);
	//}
//});
...
$(document).ready(function(){
	 ...
	 $("#InvoiceCompanyid").val([" "]).select2();
	 $("#InvoiceInvoiceType").val([" "]).select2();
	 $("#InvoiceVirtual").val([1,0]).select2();
	 $("#InvoicePaid").val([1,0]).select2();
	...
	//Selecting a row in a data table
